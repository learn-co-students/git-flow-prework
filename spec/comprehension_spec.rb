...
# describe "PUSHING:" do
  ...
  it "6. From the feature branch 'add-links', what is the syntax for creating
  a remote add-links branch with all of the local branch's content?(remote is
  still called 'origin')" do
